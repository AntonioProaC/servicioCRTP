...
public class CorteAnterior {
    @Id
       ...
       public CorteAnterior(){
       }
       
        public CorteAnterior(int keyx,int numCliente,int iduLogica,int impAbonosCorte,int numCorte, int prcDineroE,int impDineroCorte,Date fecAlcanzoMesPuntual,Date fecCorteCartera,int abonoBase){
           this.keyx=keyx;
       ...
       public CorteAnterior(int numCliente,int iduLogica,int impAbonosCorte,int numCorte, int prcDineroE,int impDineroCorte,Date fecAlcanzoMesPuntual,Date fecCorteCartera,int abonoBase){
           this.numCliente = numCliente;
           this.iduLogica = iduLogica;
           this.impAbonosCorte = impAbonosCorte;
           this.prcDineroE = prcDineroE;
